...
* Количество колонок (Number of Columns) установить равным количеству вариантов ответа (5 для 5-балльной шкалы, 7 для 7-былльной и т.д.), **включая "Затрудняюсь ответить"**  
