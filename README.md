...
* [createRank](#createrankopts) 
* [tdOnClick](#tdonclick)
* [changeConstantSumOrExclusive](#changeconstantsumorexclusiveopts)  
* [existAnswerForOtherSpecify](#existanswerforotherspecifyopts)  
* [prescriptFunnel, prescriptFunnelNoPrescribing](#prescriptfunnelopts)  
* [starRating](#starratingopts)  
* [emojiRating](#emojiratingopts)  
* [checkAnswerInTable](#checkanswerintableopts)  
* [createSlider](#createslideropts)  
* [checkPSM](#checkpsmopts) 
